...
import {SwirlToken} from './SwirlToken.sol';
...
contract SwirlPoolToken is UUPSProxiable, SwirlToken, ISwirlPoolToken {
    ...
    function initialize(
        ...
        _host = ISwirlPool(host);

        // register interfaces
        ERC777Helper.register(address(this));

        emit SwirlPoolTokenCreated(host, address(underlyingToken));
    }
    ...
    function _move(
        ...
        SwirlToken._move(from, to, amount);
